...
Cuando el frontend corre en Docker, la configuración usa `host.docker.internal` para alcanzar el puerto MySQL expuesto por el contenedor de base de datos.
